...
class Database:
    ...
    def add_test(self, repo_id: int, node_id: str, file_path: str,
                 class_name: Optional[str] = None, test_name: Optional[str] = None) -> int:
    ...
    def add_generator_usage(self, test_id: int, generator_name: str,
                           count: int = 1, is_composite: bool = False, is_custom: bool = False):
    ...
    def add_property_type(self, test_id: int, property_type: str, confidence: float = 1.0):
    ...
    def add_test_code(self, test_id: int, source_code: str, ast_json: Optional[str] = None):
    ...
    def update_repository_status(self, repo_id: int, status: str, error_message: Optional[str] = None):
    ...
    def update_test_status(self, test_id: int, status: str, error_message: Optional[str] = None):
