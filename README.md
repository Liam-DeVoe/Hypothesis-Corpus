...
Each dataset release corresponds to a specific tag in this repository:
- `v1` tag corresponds to the version used for [Hypothesis Corpus 2026](https://huggingface.co/datasets/HypothesisWorks/Hypothesis-Corpus-2026).
